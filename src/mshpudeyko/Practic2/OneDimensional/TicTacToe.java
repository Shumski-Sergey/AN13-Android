...
public class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (checkRows(array, player1, player2) == true) return;
            if (checkCols(array, player1, player2) == true) return;
            if (checkDiagonals(array, player1, player2) == true) return;
            if (draw(array, player1, player2) == true) return;
            while (true) {
